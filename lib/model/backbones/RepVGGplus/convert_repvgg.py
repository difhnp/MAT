...
sys.path.append('../')
from lib.model.backbones.RepVGGplus.repvgg import get_RepVGG_func_by_name, repvgg_model_convert
...
parser.add_argument('-a', '--arch', metavar='ARCH', default='RepVGG-A2')

def convert():
    args = parser.parse_args()

    if 'plus' in args.arch:
        from lib.model.backbones.RepVGGplus.repvggplus import get_RepVGGplus_func_by_name
